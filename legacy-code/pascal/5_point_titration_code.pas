...
perC03:=1/(tento(2*ph)/(tento(pk11)*tento(pk22)) + tento Cph)/tentoCpk22) + 1);
end;
...
15: begin
value[posy-1]:= 6.nvalue[posyJ+20; G0T0XY(37,posy+1);
...
MAt1:= 1/dHAcalk(pH3,pH4) * ((vx4vx3)*caMCt1*dH2C03alk(pH3,pH4)  MNH3(pH3,pH4) - MHP04(pH3,pH4)  MH20(vx3,vx4,pH3,pH4));
...
MAt2:= 1/dHAcalk(pH1,pH4) * ((vx4-vx1)*caMCt1*dH2C03alk(pH1,pH4) - MNH3(pH1,pH4)  MHP04(pH1,pH4)  MH20(vx1,vx4,pH1,pH4));
